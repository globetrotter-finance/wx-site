...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "fixed transform w-[100%] from-blue-700 to-blue-400 z-50 shadow-md rounded-2xls border border-gray-200" }, _attrs))} data-v-96f6afb7>`);
      _push(ssrRenderComponent(_component_el_row, { class: "container mx-auto flex items-center justify-between" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_link, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_0)} alt="Saras" style="${ssrRenderStyle({ "height": "40px", "width": "auto" })}" class="p-1" data-v-96f6afb7${_scopeId3}><span class="text-xl bg-gradient-to-r from-blue-700 to-blue-400 bg-clip-text text-transparent whitespace-nowrap" data-v-96f6afb7${_scopeId3}>Saras Finance</span>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_0,
            ...
            _push2(`<div class="hidden md:flex items-center space-x-3 flex-shrink-0" data-v-96f6afb7${_scopeId}>`);
            ...
            _push2(`</div><div class="md:hidden flex items-center" data-v-96f6afb7${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_button, {
      ...
      _push(ssrRenderComponent(_component_el_drawer, {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_link, {
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", _imports_0)} alt="Saras" style="${ssrRenderStyle({ "height": "40px", "width": "auto" })}" class="p-1" data-v-96f6afb7${_scopeId2}><span class="text-xl bg-gradient-to-r from-blue-700 to-blue-400 bg-clip-text text-transparent whitespace-nowrap" data-v-96f6afb7${_scopeId2}> Saras Finance </span>`);
                } else {
                  return [
                    createVNode("img", {
                      src: _imports_0,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-4 flex flex-col h-full" data-v-96f6afb7${_scopeId}>`);
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-96f6afb7"]]);
...
//# sourceMappingURL=Footer-DEt8svul.mjs.map
