...
import { H as Header, _ as _sfc_main$2 } from './Footer-B93YZ10M.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const features = [
      ...
      {
        icon: "\u{1F4CA}",
        title: "360\xB0 Compliance Dashboard",
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(ElButton), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` \u{1F449} Talk to our Compliance Expert `);
                } else {
                  return [
                    createTextVNode(" \u{1F449} Talk to our Compliance Expert ")
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=compliance-governance-InhnAxWV.mjs.map
