...
import { H as Header, _ as _sfc_main$6 } from './Footer-TtXCfTIV.mjs';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "bg-gradient-to-br from-blue-50 via-white to-blue-50 py-16 md:py-24 px-4 relative overflow-hidden" }, _attrs))} data-v-83684126><div class="absolute inset-0 overflow-hidden pointer-events-none" data-v-83684126><div class="absolute top-10 -right-20 sm:top-20 sm:-right-40 w-64 sm:w-96 h-64 sm:h-96 bg-blue-100 rounded-full opacity-60 blur-3xl" data-v-83684126></div><div class="absolute bottom-10 -left-20 sm:bottom-20 sm:-left-40 w-64 sm:w-96 h-64 sm:h-96 bg-blue-100 rounded-full opacity-60 blur-3xl" data-v-83684126></div><div class="absolute -bottom-10 sm:-bottom-20 right-1/4 w-48 sm:w-64 h-48 sm:h-64 bg-blue-200 rounded-full opacity-40 blur-3xl" data-v-83684126></div></div>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h2 class="text-3xl sm:text-5xl md:text-6xl font-bold text-gray-800 text-center mb-8" data-v-83684126${_scopeId2}> We are <span class="text-blue-600" data-v-83684126${_scopeId2}>redefining</span> how<br data-v-83684126${_scopeId2}></h2><h2 class="text-3xl sm:text-5xl md:text-6xl font-bold text-gray-800 text-center mb-12" data-v-83684126${_scopeId2}> Legal, Audit &amp; Finance Firms work </h2><p class="mt-10 text-center text-2xl" data-v-83684126${_scopeId2}> AI-powered, ISO-certified, and built for scale \u2014 </p><p class="mt-4 mb-6 text-center text-2xl" data-v-83684126${_scopeId2}><span class="text-blue-600 fw-bold" data-v-83684126${_scopeId2}>Saras</span> helps you automate, analyze, and manage everything from litigation to compliance and knowledge. </p><div class="relative h-16 flex flex-col items-center justify-center mt-15 overflow-hidden" data-v-83684126${_scopeId2}><div${ssrRenderAttrs({
                    name: "scroll-up",
                    class: "relative w-full h-16 flex items-center justify-center"
                  })} data-v-83684126>`);
                  ssrRenderList([currentTitle.value], (title, idx) => {
                    _push3(`<div class="flex items-center justify-center gap-2 text-3xl sm:text-5xl md:text-6xl font-bold text-gray-800 animated-title absolute w-full h-full top-0 left-0 transition-transform duration-700" data-v-83684126${_scopeId2}>`);
                    ...
                    _push3(`<span data-v-83684126${_scopeId2}>${ssrInterpolate(title)}</span></div>`);
                  });
                  _push3(`</div></div><div class="flex justify-center" data-v-83684126${_scopeId2}><img${ssrRenderAttr("src", _imports_0)} data-v-83684126${_scopeId2}></div>`);
                } else {
                  return [
...
const HeroSection = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-83684126"]]);
...
//# sourceMappingURL=index-dYdROCP0.mjs.map
