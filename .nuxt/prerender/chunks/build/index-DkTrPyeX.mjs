...
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrRenderVNode } from 'file:///home/devanshkhandelwal/iwx/wx-site2/wx-site/node_modules/vue/server-renderer/index.mjs';
import { useHead } from 'file:///home/devanshkhandelwal/iwx/wx-site2/wx-site/node_modules/@vueuse/head/dist/index.mjs';
import { H as Header, _ as _sfc_main$6 } from './Footer-gOwrCnHG.mjs';
...
const _imports_0 = "" + buildAssetsURL("home-hero-cropped.CZN5sQGK.gif");
const iconSize = "1em";
const _sfc_main$5 = {
  __name: "HeroSection",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "bg-gradient-to-br from-blue-50 via-white to-blue-50 py-16 md:py-24 px-4 relative overflow-hidden" }, _attrs))} data-v-aa73ea39><div class="absolute inset-0 overflow-hidden pointer-events-none" data-v-aa73ea39><div class="absolute top-10 -right-20 sm:top-20 sm:-right-40 w-64 sm:w-96 h-64 sm:h-96 bg-blue-100 rounded-full opacity-60 blur-3xl" data-v-aa73ea39></div><div class="absolute bottom-10 -left-20 sm:bottom-20 sm:-left-40 w-64 sm:w-96 h-64 sm:h-96 bg-blue-100 rounded-full opacity-60 blur-3xl" data-v-aa73ea39></div><div class="absolute -bottom-10 sm:-bottom-20 right-1/4 w-48 sm:w-64 h-48 sm:h-64 bg-blue-200 rounded-full opacity-40 blur-3xl" data-v-aa73ea39></div></div>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h2 class="text-3xl sm:text-5xl md:text-6xl font-bold text-gray-800 text-center mb-8" data-v-aa73ea39${_scopeId2}> We are <span class="text-blue-600" data-v-aa73ea39${_scopeId2}>redefining</span> how<br data-v-aa73ea39${_scopeId2}></h2><h2 class="text-3xl sm:text-5xl md:text-6xl font-bold text-gray-800 text-center mb-12" data-v-aa73ea39${_scopeId2}> Legal, Audit &amp; Finance Firms work </h2><p class="mt-10 text-center text-2xl" data-v-aa73ea39${_scopeId2}> AI-powered, ISO-certified, and built for scale \u2014 </p><p class="mt-4 mb-6 text-center text-2xl" data-v-aa73ea39${_scopeId2}><span class="text-blue-600 fw-bold" data-v-aa73ea39${_scopeId2}>Saras</span> helps you automate, analyze, and manage everything from litigation to compliance and knowledge. </p><div class="relative h-16 flex flex-col items-center justify-center mt-15 overflow-hidden" data-v-aa73ea39${_scopeId2}><div${ssrRenderAttrs({
                    name: "scroll-up",
                    class: "relative w-full h-16 flex items-center justify-center"
                  })} data-v-aa73ea39>`);
                  ssrRenderList([currentTitle.value], (title, idx) => {
                    _push3(`<div class="flex items-center justify-center gap-2 text-3xl sm:text-5xl md:text-6xl font-bold text-gray-800 animated-title absolute w-full h-full top-0 left-0 transition-transform duration-700" data-v-aa73ea39${_scopeId2}>`);
                    ...
                    _push3(`<span data-v-aa73ea39${_scopeId2}>${ssrInterpolate(title)}</span></div>`);
                  });
                  _push3(`</div></div><div class="flex justify-center" data-v-aa73ea39${_scopeId2}><img${ssrRenderAttr("src", _imports_0)} data-v-aa73ea39${_scopeId2}></div>`);
                } else {
                  return [
...
const HeroSection = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-aa73ea39"]]);
  ...
  setup(__props) {
    const solutions = [
      {
        ...
        "description": "<br>Stay in control with a 360\xB0 compliance view.<br><br>Track regulatory and internal obligations, monitor risk zones, and enforce closure accountability.",
        "checklistItems": [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(solutions, (item) => {
        var _a;
        _push(`<div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 overflow-hidden group"><div class="p-6"><h3 class="text-xl font-semibold mb-2">${ssrInterpolate(item.title)}</h3><p class="text-gray-600 mb-4">${(_a = item.description) != null ? _a : ""}</p><ul class="space-y-2"><!--[-->`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h2 class="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-800 text-center mb-10" style="${ssrRenderStyle({ "line-height": "1.5em" })}" data-v-efef9c77${_scopeId2}> With our Game Changing <span class="text-2xl sm:text-4xl md:text-5xl font-bold text-blue-600" data-v-efef9c77${_scopeId2}>Agentic Solutions</span> which is built specially for finance and legal teams, our AI solutions do not <span class="text-2xl sm:text-4xl md:text-5xl font-bold text-blue-600" data-v-efef9c77${_scopeId2}>hallucinate</span> and still remains creative. It gives you the atmost accuracy with your <span class="text-2xl sm:text-4xl md:text-5xl font-bold text-blue-600" data-v-efef9c77${_scopeId2}>enterprise data</span>. </h2><p class="text-gray-600 text-base sm:text-lg md:text-xl mt-4 text-center max-w-3xl mx-auto" data-v-efef9c77${_scopeId2}> Unlock lightning-fast productivity and seamless integration \u{1F680} </p>`);
                } else {
                  return [
                    createVNode("h2", {
                    ...
                    createVNode("p", { class: "text-gray-600 text-base sm:text-lg md:text-xl mt-4 text-center max-w-3xl mx-auto" }, " Unlock lightning-fast productivity and seamless integration \u{1F680} ")
                  ];
                }
              }),
              _: 1
        ...
        _push(ssrRenderComponent(_component_el_card, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              ...
              _push2(`</div><h3 class="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 text-center" data-v-efef9c77${_scopeId}>${ssrInterpolate(value.title)}</h3><p class="text-gray-600 text-sm sm:text-base leading-relaxed text-center" data-v-efef9c77${_scopeId}>${(_a = value.description) != null ? _a : ""}</p>`);
            } else {
              return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_button, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(` \u{1F449} Talk to our Agentic Experts `);
                      } else {
                        return [
                          createTextVNode(" \u{1F449} Talk to our Agentic Experts ")
                        ];
                      }
                    }),
                    _: 1
...
//# sourceMappingURL=index-DkTrPyeX.mjs.map
