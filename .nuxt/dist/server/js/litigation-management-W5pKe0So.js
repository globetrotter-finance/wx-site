...
import { H as Header, _ as _sfc_main$2 } from "./Footer-TtXCfTIV.js";
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(ElButton), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` 👉 Talk to our Litigation Expert `);
                } else {
                  return [
                    createTextVNode(" 👉 Talk to our Litigation Expert ")
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=litigation-management-W5pKe0So.js.map
